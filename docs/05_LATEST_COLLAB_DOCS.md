...
| 模型层 / 小七人格切换 | `docs/collaboration/model-layer/` | active | P3-P6 / P6.1 / **P6.2** 已交付;P7 深度设计完成:不采用纯 RAG/全量 prompt/纯 planner,采用 Hybrid Purposeful Context Orchestrator,常驻核心 + 状态优先 + 白名单 skill 按需读取,保护小七角色输出 |
