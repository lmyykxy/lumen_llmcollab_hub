...
> 五个模型开始任何任务前，先读本文件。
> 当前结构版本：v1.1
> 本版变更：补充 P7 深度设计；对比 Claude Skills、LangChain context engineering、LlamaIndex Router、OpenAI tools、Semantic Kernel plugins 后，确定采用 Hybrid Purposeful Context Orchestrator。
